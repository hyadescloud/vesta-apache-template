...
if [ ! -f "/home/$1/web/$2/public_html/index.php" ]; then
	# Download prestashop
	wget https://download.nextcloud.com/server/releases/nextcloud-22.2.3.zip -O /home/$1/tmp/nextcloud.zip
	unzip -d /home/$1/web/$2/ /home/$1/tmp/nextcloud.zip
	rm -rf /home/$1/tmp/nextcloud.zip
        # chown -R $1:$1 /home/$1/web/$2/public_html
	# chown -R $1:$1 /home/$1/web/$2/nextcloud
	rm -rf /home/$1/web/$2/public_html/*
	mv /home/$1/web/$2/nextcloud/* /home/$1/web/$2/public_html/
	rm -rf /home/$1/web/$2/nextcloud
	chown -R $1:$1 /home/$1/web/$2/public_html
fi

# Moodle data directory
if [ ! -d "/home/$1/web/$2/nextcloud_data" ]; then 
        mkdir -p /home/$1/web/$2/nextcloud_data
        chown -R $1:$1 /home/$1/web/$2/nextcloud_data
fi
