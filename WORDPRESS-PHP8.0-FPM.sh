...
if [ ! -f "/home/$1/web/$2/public_html/index.php" ]; then
	...
	wget https://wordpress.org/latest.zip -O /home/$1/tmp/wordpress.zip
	unzip -d /home/$1/web/$2/private/ /home/$1/tmp/wordpress.zip
	rm -rf /home/$1/tmp/wordpress.zip
	mv /home/$1/web/$2/private/wordpress/* /home/$1/web/$2/public_html/
        chown -R $1:$1 /home/$1/web/$2/public_html
	rm -rf /home/$1/web/$2/private/wordpress
fi
